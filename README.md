...
>[!WARNING]
> **Critical: check your GitHub Pages "Source" setting first.** Go to your repository's **Settings → Pages**. The **Source** dropdown must match whichever deployment path below you intend to use:
